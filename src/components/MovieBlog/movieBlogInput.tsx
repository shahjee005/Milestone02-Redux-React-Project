...
export class MovieBlogInput extends Component<
  IMovieBlogInputProps,
  IMovieBlogInputState
> {
    ...
    return (
      <Fragment>
        <Grid.Row>
          <Input
            size="big"
            placeholder="Type your coments here...."
          ...
          <Button
            ...
            color="facebook"
            content="Submit"
            onClick={() => this.onClickAddBlogPost(newBlogPosts)}
          />
        </Grid.Row>
      </Fragment>
    );
...
export default connect(mapStateToProps, { addBlogPosts })(MovieBlogInput);
